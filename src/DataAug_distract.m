function DataAug_distract(person,root)
    participant = person;
...
%        mat_read_path1 = strcat('P_',participant,'/MSSTFeature/distractMotion/',motion_name,'/MSSTFeature');
        mat_read_path1 = strcat(root,'/',motion_name,'/MSSTFeature');
        mat_save_path1 = strcat(participant,'/MSSTFeature_new/peak_distractMotion','/',motion_name);
...
%        acc_count = length(accs)-2;
        ...
        for j = 1:120
            ...
            MSST_motion1=onedata.MSST_motion1;
            % 遍历剩下的文件
            for i = 1:120
                i_times_number = i;
                ...
                MSST_motion2=tmpdata.MSST_motion2;
